...
#define C_DELIVERY_CARDFEED_RATIO_ADDR 0x10 // float
#define C_BTRFEED_CARDFEED_RATIO_ADDR 0x14 // float
#define C_AFFEED_BTRFEED_RATIO_ADDR 0x18 // float
...
#define DEFAULT_BTRFEED_CARDFEED_RATIO 1.01
#define DEFAULT_AFFEED_BTRFEED_RATIO 1.01
